    ...
    ; (function () {
        ...
        MyPlane.prototype = {
            createPlane(e) {
                ...
                this.plane.src = '@/assets/images/plane-game/myPlane.png';
                this.plane.width = 70;
                this.plane.height = 70;
                this.plane.style.left = e.pageX - wrap.offsetLeft - (this.plane.width / 2) + 'px';
                this.plane.style.top = e.pageY - wrap.offsetTop - (this.plane.height / 2) + 'px';
            ...
            move() {
                ...
                this.maxLeft = 0;
                this.maxRight = wrap.offsetWidth - this.plane.width;
                document.addEventListener('mousemove', function (e) {
                    this.nowLeft = e.pageX - wrap.offsetLeft - (this.plane.width / 2);
                    this.nowTop = e.pageY - wrap.offsetTop - (this.plane.height / 2);
        ...
        Enemy.prototype = {
            createEnemy() {
                ...
                this.enemy.src = i % 5 ? '../assets/images/plane-game/enemy_small.png' : '../assets/images/plane-game/enemy_big.png';
                this.enemy.width = i % 5 ? 70 : 140;
                this.enemy.height = i % 5 ? 70 : 140;
                this.enemy.style.left = retRandom(-this.enemy.width / 2, wrap.offsetWidth - this.enemy.width / 2) + 'px';
            ...
            move() {
                function fn() {
                    ...
                    if (this.nowTop < wrap.offsetHeight) {
        ...
        Bullet.prototype = {
            createBullet() {
                ...
                this.bullet.src = '../assets/images/plane-game/hotDog.png';
        ...
        Boom.prototype = {
            createBoom(enemy) {
                ...
                this.boom.src = enemy.classList.contains("big") ? '../assets/images/plane-game/boom_big.png' : '../assets/images/plane-game/boom_small.png';
